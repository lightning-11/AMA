...
namespace BookSystem.Models
{
    public class BookService
    {
        ...
        /// </summary>
        /// <param name="book"></param>
        public void EditBook(Models.Book book)
        {
        ...
        /// <param name="bookId"></param>
        /// <returns></returns>
        public List<Models.BookLendRecord> GetLendRecordById(String bookId)
        {
            DataTable dt = new DataTable();
        ...
        /// <returns></returns>
        private List<Book> MapBookDataToList(DataTable BookDataTable)
        {
        ...
        /// <returns></returns>
        private List<BookLendRecord> MapBookLendRecordToList(DataTable LendRecordTable)
        {
            List<BookLendRecord> result = new List<BookLendRecord>();
            foreach (DataRow row in LendRecordTable.Rows)   //讀每一個row
            {
                result.Add(new BookLendRecord()   //將每一行row 加進去
                {
